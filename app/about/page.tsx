function AboutPage() {
  return (
    <section>
      ...
      <p className="mt-6 tracking-wide leading-8 max-w-2xl mx-auto text-muted-foreground">
      ...
      <h2 className="mt-12 text-3xl font-bold tracking-wide text-center">
        Our Mission
      </h2>
      <ul className="mt-6 list-decimal list-inside max-w-2xl mx-auto tracking-wide leading-8 text-muted-foreground">
        <li>
      ...
      <p className="mt-3 tracking-wide leading-8 max-w-2xl mx-auto text-muted-foreground">
