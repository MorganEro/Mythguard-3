    ...
    <section>
      ...
      <div className="mt-6 flex flex-col gap-y-8 relative">
        ...
        <div className="flex gap-x-4 items-center">
          <p>Start Date: <strong> {startDate.toLocaleDateString()}</strong></p>
          <p>End Date: <strong> {endDate.toLocaleDateString()}</strong></p>
        </div>
      ...
      <article className="mt-10 grid grid-cols-2 gap-4">
        <div>
      ...
      <div className="flex justify-between mt-4 text-muted-foreground">
        ...
        {isUpdated && <p>Last Updated: {updatedAt.toLocaleDateString()}</p>}
      </div>
    </section>
  );
}
